        ...
        <div className="row mb-3">
          <div className="col-md-4">
            <div className="d-flex align-items-center justify-content-center mb-2">
              <img src={vite} alt="HaptiqMart-Logo" width="50" height="50" className="me-2" />
              <h5 className="mb-0">HaptiqMart</h5>
            </div>
            <p>Your one-stop shop for all your needs.</p>
          </div>

          <div className="col-md-4">
            <h5>Quick Links</h5><hr className="bg-light" />
          ...
          <div className="col-md-4">
            <h5>Contact</h5><hr className="bg-light" />
